...
class LCindexedCSVdatabaseVisualiseLocalConnectomeClass
{
	...
	private: int calculateConnectionFlowType(const bool generate2Dvisualisation, const int coloursetNumber, const double xCalibratedPre, const double yCalibratedPre, const double xCalibratedPost, const double yCalibratedPost, const double xCalibratedAverage);
